...
export default function Header() {
  ...
  return <header className="bg-gradient-to-r from-purple-900 via-violet-800 to-purple-900 border-b border-[#8B5CF6]/20 sticky top-0 z-40 backdrop-blur-sm w-full">
      <div className="container flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-2">
          <a href="/" className="flex items-center gap-2 group relative">
            <div className="relative">
              <TestTube className="w-6 h-6 sm:w-8 sm:h-8 text-[#8B5CF6] rotate-12 transition-all duration-500 group-hover:rotate-0 transform-gpu" strokeWidth={2.5} />
              <div className="absolute inset-0 flex items-center justify-center">
                <Beaker className="w-4 h-4 sm:w-5 sm:h-5 text-[#D946EF] opacity-90 animate-[pulse_2s_ease-in-out_infinite] transform-gpu" style={{
            ...
            <span className="text-lg sm:text-2xl font-bold bg-gradient-to-r from-[#8B5CF6] via-[#D946EF] to-[#8B5CF6] bg-clip-text text-transparent font-space tracking-wider hover:scale-105 transition-transform duration-300" style={{
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="relative flex items-center gap-2" size="sm">
                ...
                <span className="hidden sm:inline-block text-white/90">John Doe</span>
              </Button>
            </DropdownMenuTrigger>
